...
export const portfolioCategories: PortfolioCategory[] = [
  {
    ...
    name: 'Kitchens',
    slug: 'kitchens',
    description: 'Beautiful kitchen remodel Escondido CA, kitchen remodel San Diego, kitchen remodel Poway, kitchen remodeling services, kitchen renovation San Diego, and Escondido kitchen remodeling transformations featuring modern designs, custom cabinetry, and premium finishes by BNC Builders.',
  ...
  },
  {
    ...
    name: 'Bathrooms',
    slug: 'bathrooms',
    description: 'Luxurious bathroom remodeling Escondido, bathroom remodeling San Diego, and bathroom remodel Escondido projects with spa-like features, elegant fixtures, and custom tilework by BNC Builders.',
  ...
  },
  {
    ...
    name: 'ADUs',
    slug: 'adus',
    description: 'ADUs San Diego and ADUs Los Angeles that maximize your property value with thoughtful design and quality construction by BNC Builders - the remodeling Escondido experts.',
  ...
  },
  {
    ...
    slug: 'exterior',
    description: 'Stunning exterior remodeling and exterior remodelers projects including outdoor kitchens, deck repair San Diego, deck repair contractor services, landscape remodeling, hardscaping, and 3D landscape design near me by BNC Builders.',
  ...
  },
  {
    ...
    name: 'Common Areas',
    slug: 'common-areas',
    description: 'Living spaces, dining rooms, and entryways transformed with attention to detail and craftsmanship by BNC Builders - the remodeling Escondido and Escondido remodeling experts for room addition San Diego and garage remodeling.',
