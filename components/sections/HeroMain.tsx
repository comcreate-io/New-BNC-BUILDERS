          ...
          <div className="hidden lg:block">
            <div className="relative animate-[fadeInRight_0.8s_ease-out_0.5s_both]">
              ...
              <div className="absolute top-4 right-4 z-10">
                <div className="bg-white rounded-xl px-5 py-4 shadow-2xl border-l-4 border-gold">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-zinc-900 leading-none">30+</p>
                      <p className="text-sm font-medium text-gold uppercase tracking-wide">Years Experience</p>
                    </div>
                  </div>
                </div>
              </div>
